# Publishing MediWyz as an Android App on Google Play Store

## Overview

MediWyz is a PWA (Progressive Web App) that can be wrapped as a native Android APK and published to the Google Play Store. This document covers the three main approaches, requirements, and step-by-step instructions.
...
#   - Package name: com.mediwyz.app
#   - App name: MediWyz
#   - Launcher name: MediWyz
#   - Theme color: #2563eb
...
npx cap init MediWyz com.mediwyz.app --web-dir out
...
### Useful Capacitor Plugins for MediWyz
