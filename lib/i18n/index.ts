...
export const LANGUAGE_STORAGE_KEY = 'mediwyz_lang'
...
export function setLanguage(lang: SupportedLanguage): void {
  ...
  window.dispatchEvent(new CustomEvent('mediwyz:lang-change', { detail: lang }))
}
...
export function useTranslation() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('mediwyz:lang-change', handler)
    ...
    return () => {
      window.removeEventListener('mediwyz:lang-change', handler)
