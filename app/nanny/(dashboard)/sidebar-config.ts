import { FaHome, FaNewspaper, FaBriefcaseMedical, FaVideo, FaComments, FaMoneyBillWave, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaFlask, FaAmbulance, FaCapsules } from 'react-icons/fa'
