import { FaHome, FaNewspaper, FaCalendarCheck, FaStar, FaVideo, FaUserFriends, FaComments, FaClipboardList, FaMoneyBillWave, FaHeart, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaFlask, FaAmbulance, FaCapsules } from 'react-icons/fa'
