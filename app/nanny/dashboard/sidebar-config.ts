import { FaHome, FaCalendarCheck, FaDollarSign, FaStar, FaCog, FaVideo, FaUserFriends, FaComments, FaGlobe, FaClipboardList } from 'react-icons/fa'
import type { SidebarItem } from '@/components/dashboard/DashboardSidebar'

const base = '/nanny/dashboard'

export const NANNY_SIDEBAR_ITEMS: SidebarItem[] = [
  { id: 'overview', label: 'Overview', icon: FaHome, color: 'text-purple-600', bgColor: 'bg-purple-50', href: base },
  { id: 'bookings', label: 'Bookings', icon: FaCalendarCheck, color: 'text-blue-600', bgColor: 'bg-blue-50', href: `${base}/bookings` },
  ...
  { id: 'families', label: 'Families', icon: FaUserFriends, color: 'text-pink-600', bgColor: 'bg-pink-50', href: `${base}/families` },
  ...
  { id: 'settings', label: 'Settings', icon: FaCog, color: 'text-gray-600', bgColor: 'bg-gray-50', href: '/nanny/settings' },
]
...
export function getActiveSectionFromPath(pathname: string): string {
  ...
  const match = NANNY_SIDEBAR_ITEMS.find((item) => item.id === segment)
