...
export const metadata: Metadata = {
  title: 'Terms of Service - Oh My Dok',
  description: 'Oh My Dok Terms of Service',
}

export default function TermsPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold mb-8">Oh My Dok – Terms of Service (TOS)</h1>
      
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">1. Introduction</h2>
        <p>Welcome to Oh My Dok. We provide a digital platform connecting users with licensed healthcare providers, diagnostic laboratories, and pharmacies.</p>
        ...
        <p>If you do not agree with these terms, you must not use Oh My Dok.</p>
      </section>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">2. Nature of Services</h2>
        <p>Oh My Dok is not a medical provider. It facilitates connections between users and independent licensed healthcare professionals and service providers.</p>
        <p>Oh My Dok does not control, direct, or interfere with the professional judgment of providers.</p>
      ...
      <section className="mb-6">
        ...
        <p>Oh My Dok disclaims all liability for:</p>
        ...
        <p>Products purchased via Oh My Dok Marketplace are sold and fulfilled by third-party vendors. Oh My Dok assumes no warranty or liability for product safety, quality, or efficacy.</p>
      </section>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">4. Eligibility and Use by Children</h2>
        <p>Users must be 18 years or older to register and use Oh My Dok independently.</p>
        <p>Minors may only use Oh My Dok under the supervision and consent of a parent or legal guardian, who assumes full responsibility for the minor’s use of the platform.</p>
      </section>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">5. Data Protection & Privacy (Mauritius DPA 2017)</h2>
        <p>Oh My Dok complies with the Mauritius Data Protection Act 2017.</p>
      ...
      <section className="mb-6">
        ...
        <p>Provider Delays: Oh My Dok is not liable for delays caused by providers. If a provider fails to attend, you will be entitled to a rescheduled session or refund (as applicable).</p>
      </section>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">7. Emergency Use Disclaimer</h2>
        <p>Oh My Dok is not for emergency medical care.</p>
