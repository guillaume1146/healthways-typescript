      ...
      <div className="p-4 sm:p-5 flex flex-col sm:flex-row gap-3">
        ...
        <div className="flex items-start gap-3 flex-1 min-w-0">
          <div className="relative flex-shrink-0">
            <div className="w-12 h-12 rounded-lg border-2 border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <button 
                    ...
                    className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-2.5 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 font-medium flex items-center justify-center gap-2 min-w-[150px]"
                  >
                    <FaSearch />
                    Find Plans
                  </button>
