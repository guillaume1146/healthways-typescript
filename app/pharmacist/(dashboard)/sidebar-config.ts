import { FaHome, FaNewspaper, FaPills, FaClipboardList, FaComments, FaVideo, FaMoneyBillWave, FaStar, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaFlask, FaAmbulance, FaCapsules } from 'react-icons/fa'
