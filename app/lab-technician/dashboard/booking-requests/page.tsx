...
import { FaCheck, FaTimes, FaSpinner, FaCalendarAlt, FaClock, FaEnvelope, FaPhone, FaFlask } from 'react-icons/fa'
...
export default function LabTechBookingRequestsPage() {
  ...
  const fetchBookings = useCallback(async () => {
    try {
      ...
      const res = await fetch(`/api/lab-techs/${user.id}/booking-requests`)
