import { FaHome, FaNewspaper, FaFlask, FaComments, FaVideo, FaMoneyBillWave, FaBriefcaseMedical, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaAmbulance, FaCapsules } from 'react-icons/fa'
