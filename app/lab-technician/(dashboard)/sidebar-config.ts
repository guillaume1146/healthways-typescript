import { FaHome, FaNewspaper, FaFlask, FaClipboardList, FaComments, FaVideo, FaMoneyBillWave, FaStar, FaBriefcaseMedical, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaAmbulance, FaCapsules, FaRobot } from 'react-icons/fa'
