import { FaHome, FaNewspaper, FaFlask, FaClipboardList, FaComments, FaVideo, FaMoneyBillWave, FaStar, FaBriefcaseMedical, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaAmbulance, FaCapsules } from 'react-icons/fa'
