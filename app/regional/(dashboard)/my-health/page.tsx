...
const NurseServicesContent = dynamic(() => import('../my-nurse-services/page'), { ssr: false, loading: () => <TabLoading /> })
const ChildcareContent = dynamic(() => import('../my-childcare/page'), { ssr: false, loading: () => <TabLoading /> })
const EmergencyContent = dynamic(() => import('../my-emergency/page'), { ssr: false, loading: () => <TabLoading /> })
const LabResultsContent = dynamic(() => import('../my-lab-results/page'), { ssr: false, loading: () => <TabLoading /> })
const InsuranceContent = dynamic(() => import('../my-insurance/page'), { ssr: false, loading: () => <TabLoading /> })
