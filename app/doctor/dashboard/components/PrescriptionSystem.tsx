...
const PrescriptionSystem: React.FC<Props> = ({ doctorData }) => {
  ...
  const renderPrescriptionCard = (prescription: Prescription) => (
    <div
      key={prescription.id}
      className="bg-gradient-to-br from-white/90 to-green-50/30 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-all"
    >
      <div className="p-4 sm:p-5 md:p-6">
        <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
          <div className="flex items-start gap-3 sm:gap-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg sm:rounded-xl flex items-center justify-center text-white flex-shrink-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                {prescription.medicines?.slice(0, 3).map((med: Medicine, index: number) => (
                  <span
                    key={index}
                    className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-800 rounded-full text-xs border border-blue-200 flex items-center gap-1"
                  >
                ...
                {prescription.medicines?.length > 3 && (
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-gray-50 to-slate-50 text-gray-600 rounded-full text-xs border border-gray-200">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={addMedicine}
              className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:from-green-600 hover:to-emerald-700 transition flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm"
            >
              <FaPlus />
              Add Medicine
            </button>
          ...
          {newPrescription.medicines.map((medicine, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-white/80 to-blue-50/30 rounded-lg p-3 sm:p-4 border border-gray-200"
            >
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        {templates.map((template: TemplateItem) => (
          <div
            key={template.id}
            className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-purple-200 hover:shadow-lg transition-all cursor-pointer"
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <button className="mt-3 px-3 py-1 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded text-xs hover:from-purple-600 hover:to-pink-700 transition">
                  Use Template
                </button>
              </div>
            </div>
  ...
  return (
    <div className="space-y-4 sm:space-y-5 md:space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-white">
            ...
            <div key={section.id} className="border-b border-gray-200">
              ...
              {expandedSection === section.id && (
                <div className="p-4 bg-white/60">
                  ...
                  {section.id === 'new' && renderNewPrescription()}
                  {section.id === 'templates' && renderTemplates()}
                  {section.id === 'history' && (
                    <div className="space-y-3 sm:space-y-4">
