...
export const DOCTOR_SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { id: 'analytics', label: 'Analytics', labelKey: 'nav.analytics', icon: FaChartLine, color: 'text-indigo-600', bgColor: 'bg-indigo-50', href: `${base}/analytics` },
  ...
  { id: 'settings', label: 'Settings', labelKey: 'nav.settings', icon: FaCog, color: 'text-gray-600', bgColor: 'bg-gray-50', href: '/doctor/settings' },
]
