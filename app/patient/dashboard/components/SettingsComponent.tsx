...
const SettingsComponent: React.FC<Props> = ({ patientData, setPatientData }) => {
  ...
  const tabs = [
    { id: 'profile', label: 'Profile', icon: FaUser, color: 'blue', gradient: 'from-blue-50 to-indigo-50' },
    { id: 'health', label: 'Health Info', icon: FaHeart, color: 'red', gradient: 'from-red-50 to-pink-50' },
    { id: 'notifications', label: 'Notifications', icon: FaBell, color: 'yellow', gradient: 'from-yellow-50 to-orange-50' },
    { id: 'security', label: 'Security', icon: FaShieldAlt, color: 'green', gradient: 'from-green-50 to-emerald-50' },
    { id: 'billing', label: 'Billing', icon: FaCreditCard, color: 'purple', gradient: 'from-purple-50 to-pink-50' },
    { id: 'subscription', label: 'Subscription', icon: FaCrown, color: 'orange', gradient: 'from-orange-50 to-yellow-50' },
    { id: 'documents', label: 'Documents', icon: FaFileAlt, color: 'indigo', gradient: 'from-indigo-50 to-purple-50' },
    { id: 'preferences', label: 'Preferences', icon: FaCog, color: 'gray', gradient: 'from-gray-50 to-slate-50' }
  ]
          ...
          {isEditing ? (
            <>
              ...
              <button
                ...
                className="p-1.5 sm:p-2 bg-gradient-to-r from-green-100 to-emerald-100 text-green-600 rounded-lg hover:from-green-200 hover:to-emerald-200 transition"
              >
                <FaSave className="text-xs sm:text-sm" />
              </button>
              <button
                onClick={() => cancelEdit(field)}
                className="p-1.5 sm:p-2 bg-gradient-to-r from-red-100 to-pink-100 text-red-600 rounded-lg hover:from-red-200 hover:to-pink-200 transition"
              >
            ...
            <>
              <input
                type={type}
                value={value}
                className="flex-1 px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 border border-gray-300 rounded-lg bg-gradient-to-r from-gray-50 to-slate-50 text-xs sm:text-sm md:text-base"
                readOnly
              />
              <button
                onClick={() => startEditing(field, value)}
                className="p-1.5 sm:p-2 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-600 rounded-lg hover:from-blue-200 hover:to-indigo-200 transition"
              >
  ...
  const renderProfileSettings = () => (
    <div className="space-y-4 sm:space-y-6 md:space-y-8">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-lg border border-blue-200">
        ...
        <div className="space-y-3 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-4 md:gap-6">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2">
              <input
                ...
                readOnly
              />
              <div className="px-2.5 sm:px-3 py-1.5 sm:py-2 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 rounded-lg text-xs sm:text-sm">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            ...
            <input
              ...
              className="w-full px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 border border-gray-300 rounded-lg bg-gradient-to-r from-gray-50 to-slate-50 text-xs sm:text-sm md:text-base"
              readOnly
            />
          </div>
        </div>
        ...
        <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-xl">
        ...
        <div className="space-y-3 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 md:gap-6">
          <div className="space-y-1.5 sm:space-y-2">
            ...
            <div className="flex items-center gap-2">
              <div className="px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-red-100 to-pink-100 text-red-700 rounded-lg font-bold text-center flex-1 text-xs sm:text-sm md:text-base">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            ...
            <div className="flex items-center gap-2">
              <div className="px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 rounded-lg font-bold text-center flex-1 text-xs sm:text-sm md:text-base">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            ...
            <div className="flex items-center gap-2">
              <div className="px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 rounded-lg font-bold text-center flex-1 text-xs sm:text-sm md:text-base">
        ...
        <div className="mt-4 sm:mt-6">
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2">
            {patientData.allergies.map((allergy, index) => (
              <span key={index} className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-red-100 to-pink-100 text-red-800 rounded-full text-xs sm:text-sm flex items-center gap-1 sm:gap-2">
            ...
            <button className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-gray-100 to-slate-100 text-gray-600 rounded-full text-xs sm:text-sm hover:from-gray-200 hover:to-slate-200 transition">
        ...
        <div className="mt-4 sm:mt-6">
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2">
            {patientData.chronicConditions.map((condition, index) => (
              <span key={index} className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-yellow-100 to-orange-100 text-yellow-800 rounded-full text-xs sm:text-sm flex items-center gap-1 sm:gap-2">
            ...
            return (
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
                  <div className="bg-gradient-to-br from-red-100 to-pink-100 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center">
                  ...
                  <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center">
                  ...
                  <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center">
                  ...
                  <div className="bg-gradient-to-br from-orange-100 to-yellow-100 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center">
      ...
      {patientData.healthMetrics && (
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-lg border border-purple-200">
          ...
          <div className="space-y-3 sm:space-y-0 sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:gap-3 md:gap-4 lg:gap-6">
            ...
            {/* BMI */}
            <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg sm:rounded-xl p-3 sm:p-4">
            ...
            {/* Sleep & Wellness */}
            <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg sm:rounded-xl p-3 sm:p-4">
          ...
          {Object.entries({
            ...
            <div key={key} className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 border border-gray-200 rounded-lg sm:rounded-xl hover:border-gray-300 transition gap-3">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className={`p-2 sm:p-3 bg-gradient-to-br from-gray-50 to-slate-50 rounded-lg ${config.color}`}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 border border-gray-200 rounded-lg sm:rounded-xl gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3 self-end sm:self-auto">
              {patientData.securitySettings.twoFactorEnabled ? (
                <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 rounded-full text-xs sm:text-sm font-medium flex items-center gap-1">
                  <FaCheck className="text-xs" />
                  Enabled
                </span>
              ) : (
                <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-gray-100 to-slate-100 text-gray-800 rounded-full text-xs sm:text-sm font-medium">
                  Disabled
                </span>
              )}
              <button
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center ${
                    billing.type === 'credit_card' ? 'bg-gradient-to-br from-blue-100 to-indigo-100 text-blue-600' : 'bg-gradient-to-br from-green-100 to-emerald-100 text-green-600'
                  }`}>
                ...
                <div className="flex items-center gap-2 self-end sm:self-auto">
                  {billing.isDefault && (
                    <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 rounded-full text-xs font-medium">
  ...
  const renderSubscriptionSettings = () => (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-white">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
      ...
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-lg border border-green-200">
        ...
        <div className="space-y-2 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-3 md:gap-4">
          {patientData.subscriptionPlan.features.map((feature, index) => (
            <div key={index} className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg">
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-lg border border-indigo-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {[
            { type: 'medical_report', label: 'Medical Reports', gradient: 'from-red-50 to-pink-50', textColor: 'text-red-600', icon: FaHeart },
            { type: 'prescription', label: 'Prescriptions', gradient: 'from-green-50 to-emerald-50', textColor: 'text-green-600', icon: FaCog },
            { type: 'lab_result', label: 'Lab Results', gradient: 'from-blue-50 to-indigo-50', textColor: 'text-blue-600', icon: FaFileAlt },
            { type: 'insurance', label: 'Insurance Documents', gradient: 'from-purple-50 to-pink-50', textColor: 'text-purple-600', icon: FaShieldAlt },
            { type: 'id_proof', label: 'ID Proof', gradient: 'from-yellow-50 to-orange-50', textColor: 'text-yellow-600', icon: FaIdCard }
          ].map((docType) => (
            <button
              key={docType.type}
              className={`p-3 sm:p-4 border-2 border-dashed border-gray-300 rounded-lg sm:rounded-xl hover:border-blue-400 transition bg-gradient-to-br ${docType.gradient} ${docType.textColor}`}
            >
  ...
  const renderPreferencesSettings = () => (
    <div className="space-y-4 sm:space-y-6">
      {/* General Preferences */}
      <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-lg border border-gray-200">
        <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-4 sm:mb-5 md:mb-6 flex items-center">
  ...
  return (
    <div className="space-y-4 sm:space-y-5 md:space-y-6">
      {/* Settings Header */}
      <div className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-white">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`flex-shrink-0 px-3 md:px-4 lg:px-6 py-3 md:py-4 text-center font-medium transition-all text-xs md:text-sm lg:text-base ${
                  activeTab === tab.id 
                    ? `text-${tab.color}-600 border-b-2 border-current bg-gradient-to-br ${tab.gradient}` 
            ...
            <div key={tab.id} className="border-b border-gray-200">
              <button
                ...
                className={`w-full px-4 py-3 flex items-center justify-between transition-all ${
                  expandedSection === tab.id ? `bg-gradient-to-r ${tab.gradient}` : 'bg-white'
                }`}
              >
                <div className="flex items-center gap-2">
