...
interface DashboardStats {
  ...
  monthlyCompletedServices: number
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Track your income and transactions</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-lg border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm font-medium">Services This Month</p>
              <p className="text-2xl font-bold text-gray-900 mt-1">{stats?.monthlyCompletedServices || 0}</p>
            </div>
        ...
        {!wallet?.transactions || wallet.transactions.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-400 text-sm mt-1">
              Your transaction history will appear here once you start completing services.
            </p>
          </div>
        ) : (
