import { FaHome, FaNewspaper, FaCalendarCheck, FaStar, FaVideo, FaComments, FaClipboardList, FaMoneyBillWave, FaMedkit, FaUsers, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaFlask, FaAmbulance, FaCapsules, FaRobot } from 'react-icons/fa'
