            ...
            >
              <div className="flex items-start gap-4">
                {patient.profileImage ? (
                  ...
                  <div className="w-14 h-14 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-full flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
