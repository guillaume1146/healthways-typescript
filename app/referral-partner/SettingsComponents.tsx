...
export const ProfileSettings = ({ profile, onProfileChange }: ProfileSettingsProps) => (
  <form className="space-y-8">
    ...
    <div className="text-right pt-6 mt-6 border-t">
      <button type="button" className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-6 py-2.5 rounded-lg font-semibold hover:shadow-lg transition-all duration-200 flex items-center gap-2 inline-flex">
        <FaSave />
        Save Profile
      </button>
    </div>
