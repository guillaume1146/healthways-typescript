import { FaHome, FaNewspaper, FaUsers, FaShieldAlt, FaComments, FaVideo, FaFileAlt, FaMoneyBillWave, FaGlobeAmericas, FaToggleOn, FaSlidersH, FaBell } from 'react-icons/fa'
