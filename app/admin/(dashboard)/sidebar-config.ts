import { FaHome, FaNewspaper, FaUsers, FaShieldAlt, FaComments, FaVideo, FaFileAlt, FaMoneyBillWave, FaGlobeAmericas, FaToggleOn, FaSlidersH, FaBell, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaFlask, FaAmbulance, FaCapsules, FaRobot } from 'react-icons/fa'
