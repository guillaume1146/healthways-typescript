  ...
  return (
    <>
      ...
      <Modal
        ...
        title="Oh My Dok Medical Disclaimer"
        ...
        <div className="space-y-6 text-gray-700">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <p className="text-red-700">
              Oh My Dok is a technology platform that connects users with licensed healthcare professionals, diagnostic service providers, and pharmacies. <strong>Oh My Dok itself does not provide medical care, diagnoses, prescriptions, or treatment.</strong> All medical advice, consultations, tests, and prescriptions are the sole responsibility of the independent licensed healthcare professionals and service providers engaged by you through our platform.
            </p>
          </div>

          <div>
            <h3 className="font-bold text-gray-800 mb-3">No Provider-Patient Relationship with Oh My Dok</h3>
            <p>
              Any consultation or advice you receive via Oh My Dok is delivered by independent, licensed practitioners. <strong>Oh My Dok does not control or interfere with their professional judgment.</strong> Your healthcare provider is solely responsible for the medical advice, quality of care, and services they provide.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Diagnostic tests, lab results, and medication dispensing are provided by independent laboratories and licensed pharmacies. <strong>Oh My Dok does not warrant the accuracy, completeness, or safety of any diagnostic tests or medications.</strong> Any issues or disputes related to these services should be addressed directly with the relevant service provider.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Oh My Dok is not designed for emergency medical situations. If you are experiencing a medical emergency, please contact your local emergency number or go to the nearest hospital. Oh My Dok should not be used as a substitute for in-person examination and treatment when required.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              To the fullest extent permitted by law, <strong>Oh My Dok is not liable for any injury, loss, or damages resulting from consultations, tests, prescriptions, medication errors, or any services provided by independent healthcare professionals or third-party providers.</strong> Users agree that Oh My Dok role is limited to facilitating communication and logistics between users and providers.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Oh My Dok complies with applicable data protection laws and takes reasonable measures to safeguard personal health information. Please refer to our Privacy Policy for details.
            </p>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <p className="text-yellow-700">
              By using Oh My Dok, you acknowledge and agree to this disclaimer and the applicable Terms of Service.
            </p>
          </div>
        </div>
      </Modal>
      ...
      <Modal
        ...
        title="Oh My Dok Terms of Service"
        icon={FaFileAlt}
      ...
      >
        <div className="space-y-6 text-gray-700">
          <div>
            ...
            <p>
              Welcome to <strong>Oh My Dok</strong>. We provide a digital platform connecting users with licensed healthcare providers, diagnostic laboratories, and pharmacies. By using our website, mobile app, or any related services, you agree to abide by these Terms of Service and our Privacy Policy.
            </p>
            <p className="mt-2 font-medium text-red-600">
              If you do not agree with these terms, you must not use Oh My Dok.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc pl-6">
              <li>Oh My Dok is <strong>not a medical provider</strong>. It facilitates connections between users and independent licensed healthcare professionals and service providers.</li>
              <li>Oh My Dok does <strong>not control, direct, or interfere</strong> with the professional judgment of providers.</li>
          ...
          <div>
            ...
            <p className="mb-2">Oh My Dok <strong>disclaims all liability</strong> for:</p>
            <ul className="space-y-2 list-disc pl-6">
            ...
            <p className="mt-2">
              Products purchased via Oh My Dok Marketplace are sold and fulfilled by third-party vendors. Oh My Dok assumes <strong>no warranty or liability</strong> for product safety, quality, or efficacy.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc pl-6">
              <li>Users must be <strong>18 years or older</strong> to register and use Oh My Dok independently.</li>
              <li>Minors may only use Oh My Dok under the <strong>supervision and consent of a parent or legal guardian</strong>, who assumes full responsibility for the minor use of the platform.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc pl-6">
              <li>Oh My Dok complies with the <strong>Mauritius Data Protection Act 2017</strong>.</li>
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc pl-6">
              <li>Oh My Dok is <strong>not for emergency medical care</strong>.</li>
          ...
          <div>
            ...
            <p>Oh My Dok may suspend or terminate access if you violate these terms or engage in abusive or unlawful conduct.</p>
          </div>

          <div>
            <h3 className="font-bold text-gray-800 mb-3">9. Amendments</h3>
            <p>Oh My Dok may update these Terms from time to time. Users will be notified of significant changes.</p>
          </div>
        </div>
      </Modal>
      ...
      <Modal
        ...
        title="Oh My Dok Privacy Policy"
        icon={FaShieldAlt}
      ...
      >
        <div className="space-y-6 text-gray-700">
          <div>
            <h3 className="font-bold text-gray-800 mb-3">1. Introduction</h3>
            <p>
              Oh My Dok is committed to safeguarding your privacy and protecting your personal data. This Privacy Policy explains how we collect, use, store, and share your information in compliance with the Mauritius Data Protection Act 2017 and any other applicable healthcare data regulations.
            </p>
          ...
          <div>
            ...
            <div className="mt-2 bg-gray-50 p-4 rounded-lg">
              <p><strong>Email:</strong> privacy@ohmydok.com</p>
              <p><strong>Address:</strong> Oh My Dok Office, Mauritius</p>
