import { FaHome, FaNewspaper, FaAmbulance, FaMapMarkerAlt, FaComments, FaVideo, FaClipboardList, FaMoneyBillWave, FaStar, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaFlask, FaCapsules } from 'react-icons/fa'
