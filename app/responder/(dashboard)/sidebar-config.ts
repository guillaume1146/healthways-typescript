import { FaHome, FaNewspaper, FaAmbulance, FaComments, FaVideo, FaClipboardList, FaMoneyBillWave, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaFlask, FaCapsules } from 'react-icons/fa'
