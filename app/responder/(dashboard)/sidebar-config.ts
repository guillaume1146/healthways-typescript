import { FaHome, FaNewspaper, FaAmbulance, FaMapMarkerAlt, FaComments, FaVideo, FaClipboardList, FaMoneyBillWave, FaStar, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaFlask, FaCapsules, FaRobot } from 'react-icons/fa'
