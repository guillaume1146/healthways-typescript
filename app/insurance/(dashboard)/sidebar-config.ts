import { FaHome, FaNewspaper, FaFileAlt, FaUsers, FaComments, FaVideo, FaMoneyBillWave, FaSearch, FaUserMd, FaUserNurse, FaBaby, FaFlask, FaAmbulance, FaCapsules } from 'react-icons/fa'
