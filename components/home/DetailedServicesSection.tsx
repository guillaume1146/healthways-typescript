...
const DEFAULT_CTA = {
  ...
  description: "Join thousands of Mauritians who trust Healthwyz for their comprehensive healthcare needs. From telehealth to physical clinics, we've got you covered.",
