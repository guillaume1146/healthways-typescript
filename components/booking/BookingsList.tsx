...
const ACCENT_GRADIENT: Record<string, { from: string; to: string; avatar: string }> = {
  pink: { from: 'from-pink-500', to: 'to-rose-600', avatar: 'from-pink-500 to-rose-600' },
  purple: { from: 'from-purple-500', to: 'to-pink-600', avatar: 'from-purple-500 to-pink-600' },
  blue: { from: 'from-blue-500', to: 'to-indigo-600', avatar: 'from-blue-500 to-indigo-600' },
  cyan: { from: 'from-cyan-500', to: 'to-blue-600', avatar: 'from-cyan-500 to-blue-600' },
  green: { from: 'from-green-500', to: 'to-emerald-600', avatar: 'from-green-500 to-emerald-600' },
}
...
export default function BookingsList({
  ...
  return (
    <div className="space-y-4">
      {/* Stats */}
      <div className={`bg-gradient-to-r ${accent.from} ${accent.to} rounded-xl p-4 text-white`}>
          ...
          >
            <div className="p-4">
              <div className="flex items-start gap-3">
                {/* Avatar */}
                <div className={`w-11 h-11 sm:w-12 sm:h-12 bg-gradient-to-r ${accent.avatar} rounded-lg flex items-center justify-center text-white font-bold text-sm flex-shrink-0`}>
