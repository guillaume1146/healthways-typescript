...
const ACCENT_STYLES: Record<string, { header: string; button: string; statBg: string }> = {
  blue: { header: 'from-blue-600 to-indigo-700', button: 'bg-blue-600 hover:bg-blue-700', statBg: 'bg-blue-50' },
  pink: { header: 'from-pink-600 to-rose-700', button: 'bg-pink-600 hover:bg-pink-700', statBg: 'bg-pink-50' },
  purple: { header: 'from-purple-600 to-indigo-700', button: 'bg-purple-600 hover:bg-purple-700', statBg: 'bg-purple-50' },
  cyan: { header: 'from-cyan-600 to-teal-700', button: 'bg-cyan-600 hover:bg-cyan-700', statBg: 'bg-cyan-50' },
  red: { header: 'from-red-600 to-red-800', button: 'bg-red-600 hover:bg-red-700', statBg: 'bg-red-50' },
  teal: { header: 'from-teal-600 to-teal-700', button: 'bg-teal-600 hover:bg-teal-700', statBg: 'bg-teal-50' },
}
...
export default function ProviderBookingRequests({
  ...
  return (
    <div>
      {/* Header */}
      <div className={`bg-gradient-to-r ${styles.header} rounded-xl p-6 text-white mb-6`}>
