...
export default function NursePaymentOptions({
  bookingData,
  onUpdate,
  onPayment,
  onBack,
  ...
  const calculateTotal = () => {
    const baseAmount = bookingData.type === 'video' 
      ? bookingData.nurse.videoConsultationRate * bookingData.duration
      : bookingData.nurse.hourlyRate * bookingData.duration
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-gray-600">
                {getServiceTypeText()} ({bookingData.duration}h)
              </span>
