...
const paymentMethods: PaymentMethod[] = [
  ...
  },
  {
    ...
    description: "Apply family care package discount (30% off)",
    discount: 30,
    icon: "👨‍👩‍👧‍👦",
    available: true
  },
  {
    id: "subscription",
    type: "subscription",
    name: "Monthly Childcare Subscription",
    description: "Use your active childcare subscription",
    discount: 100,
    icon: "💳",
    available: false
  }
...
export function NannyPaymentOptions({
  bookingData,
  onUpdate,
  onPayment,
  onBack,
  ...
  const getServiceTypeText = () => {
    return bookingData.type === 'overnight' ? 'Overnight Care' : `Regular Care (${bookingData.duration}h)`
  }
      ...
      <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 pr-12 border rounded-lg focus:outline-none focus:border-purple-600 ${
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-purple-800 mb-1">Secure Payment</h4>
              <p className="text-purple-700 text-sm">All payments are encrypted and processed securely. Your financial information is protected with bank-level security.</p>
            </div>
          </div>
        </div>
