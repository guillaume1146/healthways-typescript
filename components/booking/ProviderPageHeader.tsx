...
interface ProviderPageHeaderProps {
  ...
  title: string
  subtitle: string
  gradient: string // e.g. "from-blue-500 via-indigo-500 to-purple-600"
  onBook: () => void
...
export default function ProviderPageHeader({
  ...
  return (
    <div className={`bg-gradient-to-r ${gradient} rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-white`}>
