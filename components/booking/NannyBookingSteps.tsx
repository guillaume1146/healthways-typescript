...
// ===== NannyBookingSteps.tsx =====
import { FaBaby, FaCalendarAlt, FaInfoCircle, FaWallet, FaTicketAlt, FaCheck } from 'react-icons/fa'

interface NannyBookingStepsProps {
  currentStep: number
}

const steps = [
  { number: 1, title: "Nanny Details", icon: FaBaby },
...
export function NannyBookingSteps({ currentStep }: NannyBookingStepsProps) {
  return (
