    ...
    <>
      ...
      >
        <div className="h-full overflow-y-auto p-3 sm:p-4 md:p-5 lg:p-6 pt-16 md:pt-20 lg:pt-24">
          ...
          {/* Navigation items */}
          <nav className="space-y-1.5 sm:space-y-2 mt-8 md:mt-0">
            {items.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`block w-full text-left px-3 sm:px-3.5 md:px-4 lg:px-5 py-2.5 sm:py-3 md:py-3.5 rounded-lg sm:rounded-xl transition-all transform hover:scale-105 ${
                    isActive
