      ...
      <div className="text-center bg-white rounded-2xl p-8 shadow-xl max-w-md w-full mx-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          {onRetry && (
            <button
              onClick={onRetry}
              className="w-full sm:w-auto bg-gradient-to-r from-gray-500 to-gray-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-gray-600 hover:to-gray-700 transition-all"
            >
              Retry
            </button>
          )}
          ...
          <Link
            href={actionHref}
            className="w-full sm:w-auto inline-block bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-indigo-700 transition-all text-center"
          >
            {actionLabel}
          </Link>
        </div>
